...
6. `MAIL_*` 4종 입력 완료
7. `APP_AUDIT_REQUEST_IP_HMAC_SECRET` 준비 완료
8. `APP_SECURITY_TRUST_FORWARDED_HEADERS=true` 여부를 프록시 구조에 맞게 결정
9. maintenance runner 관련 `*_ENABLED`가 실수로 켜져 있지 않은지 확인
